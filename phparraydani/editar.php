            ...
            <div class="card mb-4 rounded-3 shadow-sm">
                ...
                <div class="card-body text-start">
                    <form action="edita.php?pos=<?php echo $pos; ?>" method="POST">
                        ...
                        <input type="text" name="cor" class="form-control" value="<?php echo $dados[$pos]; ?>" required /><br />
                        <label class="form-label">Numero</label><br />
                        <input type="number" name="numero" class="form-control" value="<?php echo $dados[$pos2]; ?>" required /><br />
                        <label class="form-label">Quantidade</label><br />
                        <input type="number" name="quantidade" class="form-control" value="<?php echo $dados[$pos3]; ?>" required /><br />
